...
<div className="w-full max-w-md mx-auto mb-6 px-4">
  ...
  <div className="flex items-center gap-2">
    ...
    >
      <option value="simple">Simple Ionic Balancing</option>
      <option value="transition">Transition Element Complexes</option>
      <option value="polyatomic">Polyatomic Ion Groupings</option>
    </select>
